...
class RAGService:
    ...
    def query_with_symptoms(self, question: str, explicit_symptoms: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        # Analyze symptoms (rule-based when no LLM is enabled).
        ...
        try:
            ...
            # If Chroma/hnswlib isn't available on this machine, degrade gracefully.
            self._logger.error("vector_search_failed: %s", e, exc_info=True)
